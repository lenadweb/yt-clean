    ...
    section('compact_mode', { isNew: true, controls: 'switch' }, [
        feature({
            ...
            styles: [
                ...
                'ytd-search ytd-channel-renderer #avatar { width: 80px !important; height: 80px !important; min-width: 80px !important; }',
                'ytd-search ytd-channel-renderer #avatar img { width: 80px !important; height: 80px !important; }',
